...
- [GameMaker](https://gamemaker.io/en): A beginner-accessible 2D game engine designed for rapid game creation using both drag-and-drop systems and its own scripting language.
- [Godot Game Engine](https://godotengine.org/): A free and open-source game engine known for its lightweight worflow, flexible node-based design, and strong support for 2D game development.
- [Pico-8](https://www.lexaloffle.com/pico-8.php): Pico-8 is a fantasy 8-bit console, existing only as software that runs on Windows, Mac, Linux, or in a web browser. The constraints of the engine make it perfect for beginners learning the basics of game development. Here is the [free education edition](https://www.pico-8-edu.com/).
- [Scratch](https://scratch.mit.edu/): A beginner-friendly visual programming engine that teaches game development and coding concepts through drag-and-drop blocks.
...
- [SpaceCat](https://www.youtube.com/channel/UC1nml5Y5DY_hyFsqa5WbZrg): SpaceCat has YouTube tutorials on how to make games using Pico-8.
